...
const GROUP_COLOR_PALETTE = [
  ...
  {
    key: "mupa-blue",
    bar: "bg-[#085CF0]/70 dark:bg-[#085CF0]/60",
    softBg: "bg-[#085CF0]/5 dark:bg-[#085CF0]/10",
    iconBg: "bg-[#085CF0]/10 text-[#085CF0] dark:bg-[#085CF0]/15 dark:text-[#085CF0]",
    iconHover: "group-hover/node:bg-[#085CF0] group-hover/node:text-white",
    badge: "bg-[#085CF0]/10 text-[#085CF0] dark:bg-[#085CF0]/15 dark:text-[#085CF0]",
    line: "bg-[#085CF0]/30 dark:bg-[#085CF0]/30",
  },
  {
    key: "violet",
